    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 pt-16">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <Send className="text-blue-400 w-12 h-12 mx-auto mb-4" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`mt-1 block w-full rounded-md bg-white/10 border-transparent focus:border-blue-500 focus:bg-white/20 focus:ring-0 text-white ${
